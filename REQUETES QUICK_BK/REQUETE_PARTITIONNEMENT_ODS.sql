...
where fg.name like ('SID_PRD_DWH_%')
...
--ALTER PARTITION SCHEME [SCH_SID_PRD_ODS_DATE] NEXT USED [SID_PRD_ODS_FG17]; 
--GO 
-------------------------------------------------------------------------------------------
---------------------------------3. Split Range Last Range---------------------------------
-------------------------------------------------------------------------------------------
----/* Then we can SPLIT */
--ALTER PARTITION FUNCTION [FCT_SID_PRD_ODS_DATE] () SPLIT RANGE ('20180131');
--GO
--*/
