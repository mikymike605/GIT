...
N'<H><b>Veuillez trouver ci dessous le tableau des &#233carts du '+CONVERT(VARCHAR(30), (cast (dateadd(day, @loop, @deb) as date)), 103)+' entre la table TICKET_UNIFIE_TEMP et TICKET_UNIFIE après chargement.</b><BR></BR></H>' + 
