CREATE DATABASE [DBAtools]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DBAtools', FILENAME = N'D:\DATA\DBAtools.mdf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DBAtools_log', FILENAME = N'L:\LOGS\DBAtools_log.ldf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
GO
ALTER DATABASE [DBAtools] SET COMPATIBILITY_LEVEL = 130
GO
