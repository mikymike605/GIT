...
N'<H><b>Veuillez trouver ci dessous le rapport du '+CONVERT(VARCHAR(30), GETDATE(), 103)+' des jobs sql en erreur pour l''instance- ' + @@SERVERNAME + '</b><BR></BR></H>' +
...
<BODY <font size = "4"color="#000000"<H>Il n''y a pas de job SQL Serveur en erreur pour le '+CONVERT(VARCHAR(30), GETDATE(), 103)+'.<BR></BR></H></tr></font>
