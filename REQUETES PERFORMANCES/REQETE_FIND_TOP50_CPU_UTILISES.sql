...
--SELECT DatePart(Month,DATEADD(m,-3,getdate()))
...
Convert(varchar, qs.creation_time, 105) as Plan_Compiled_On,
qs.execution_count as 'Total Executions',
qs.total_worker_time as 'Overall CPU Time Since Compiled',
Convert(Varchar, qs.last_execution_time, 105) as 'Last Execution Date/Time',
