...
WHERE OBJECT_NAME(I.OBJECT_ID) = 'MD5_INVOICE_DETAIL'  
...
where o.name =''REB_INVOICEDETAIL''  --TICKET_UNIFIE, SEM_TICKET, MD5_INVOICE_DETAIL, F_PRODUCT_TIMESLOT,F_PRODUCT,MD5_INVOICE,MD5_PAYEMENT
and i.index_id >0
order by 2,3'
exec (@command1);
*/
