...
declare CursorIndex cursor for
 ...
 + 'SORT_IN_TEMPDB = OFF, FILLFACTOR =90'--' + CAST(ix.fill_factor AS VARCHAR(3)) AS IndexOptions
...
begin
 ...
 set @TSQLScripCreationIndex='CREATE '+ @is_unique  +@IndexTypeDesc + ' INDEX ' +QUOTENAME(@IndexName)+' ON [MD8_ARCH]. ' + QUOTENAME(@SchemaName) +'.'+ QUOTENAME(@TableName)+ '('+@IndexColumns+') '+ 
